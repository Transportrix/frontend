            ...
            <div className="flex flex-col items-center p-4">
                ...
                <div className="flex items-center justify-center gap-5 w-full mb-4">
                    ...
                    <div className='flex flex-col gap-5'>        
                        <div className="bus-details-container border  rounded-md p-4 flex flex-col justify-between" style={{  width: '418px' }}>
                            <p>Your Bus is:</p>
                            <p className='text-primary text-3xl font-bold'>#28239</p>
                        </div>
                        <div className='flex flex-col gap-1'> 
                        <div className="flex items-center mb-2">
                                <FaChair className="text-primary mr-2" />
                                <p>12/30 seats available</p>
                            </div>
